    ...
    return (
        <div className='flex flex-row justify-between px-[170px] py-[152px] '>
            <div className='text-white flex flex-col items-start h-[415x] w-[418px] justify-between'>
                ...
                <button type='button' className='bg-[#75C310] rounded-[30px] w-[220px] h-[56px] text-[20px] font-bold'>
                    Go to portfolio
                </button>
            </div>
            <div className='h-[415px] w-[418px] p-5'>
                <img src="/src/assets/profile/circle_profile.png" alt="Profile" className='h-full w-full object-cover rounded-full border-[10px] border-[#75C310]' />
            </div>
        </div>
    )
}
